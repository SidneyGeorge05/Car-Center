...
<body>
	...
	<!-- CONTATO -->
	<div id="newsletter" class="section" style="border-top: 0; margin-top: 0;">
		<!-- container -->
		<div class="container">
			<!-- row -->
			<div class="row">
				<div class="col-md-12">
					<div class="newsletter">
						...
						<form  class="contact-form" action="https://api.staticforms.xyz/submit" method="POST">
							...
							<label for="email" style="text-align: left; margin-left: 10px">Email</label>
							<input class="input" type="email" name="email" autocomplete="off" required style="margin-bottom: 20px; width: 100%; border-radius: 40px;" placeholder="Digite seu Email">
							
							<br>
							<label for="message" style="text-align: left; margin-left: 10px">Mensagem</label>
							<input class="input" type="text" id="message" name="messsage"  autocomplete="off" required style="margin-bottom: 20px; width: 100%; height: 130px; border-radius: 40px;" placeholder="Digite seu Email">
							

							<br>
							<a href="index.php"><button type="submit" class="newsletter-btn" style="border-radius: 40px 40px 40px 40px;"><i class="fa fa-envelope" style="margin-right: 5px;"></i>Enviar</button></a>
							<input type="hidden" name="accessKey" value="bcce02dc-97d1-49c0-b109-c1c9ca3dc444">
							<!--<input type="hidden" name="accessKey" value="a8035201-b9ea-4a5f-829b-2435f852e847">-->
							<input type="hidden" name="redirectTo" value="https://abrir.link/J1Zu2">
						</form>
					</div>
				</div>
			</div>
	...
	<!--<header class="center">
                <div>
                    <img src="./img/icone-login.png" style="width: 100px;"></img>
                </div>
            ...
            <form class="contact-form" action="https://api.staticforms.xyz/submit" method="POST">
                ...
                <input type="hidden" name="accessKey" value="a8035201-b9ea-4a5f-829b-2435f852e847">
				<input type="hidden" name="redirectTo" value="https://fredericolopes.com/como-encaminhar-o-plugin-contact-form-7-para-uma-pagina-de-obrigado/">
	...
	<section style="text-align:center; border-top: 2px solid #E4E7ED;">
		<div class="container">
			...
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3657.431471821032!2d-46.40179488533771!3d-23.552942267165797!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce65086cafaf55%3A0xf7da96815e7611da!2sETEC%20de%20Guaianases!5e0!3m2!1spt-BR!2sbr!4v1664250421818!5m2!1spt-BR!2sbr" 
			...
			<div class="row">
				<div class="col-md-12">
					<div class="newsletter">
						...
						<form>
							<input class="input" type="email" placeholder="Digite seu Email" style="margin-bottom: 20px; width: 100%; border-radius: 40px;">
