         ...
         <div class="panel panel-primary">
            <div style=" width:50%; float: left;">
               ...
               <form name="cadastro-cliente" method="post" action="cadastrar-cliente.php">
                  <label for="Nome" class="espaco-form-cliente">
                  ...
                  <label for="prependedtext" class="espaco-form-cliente">
                     <span class="input-group-addon">
                        Telefone
                        <h11>*</h11>
                     </span>
                  ...
                  <label class="col-md-1 control-label" for="senha">
                  ...
                  <div class="espaco-form-cliente">
                     <input name="senha" placeholder="*********" class="form-control input-md" required="" type="password">
                  </div>
                  <label for="complemento" class="espaco-form-cliente">
                     <span class="input-group-addon">
                        Complemento
                        <h11>*</h11>
                     </span>
