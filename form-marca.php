...
<meta charset="utf-8">
	...
	<title>CarCenter - Cadastro de Marca de Veículo</title>
...
<form class="form-cliente" action="confirmacao-cadastro.php" method="POST">
        <div class="content">
            <div class="form sign-in">
                <h2 style="margin-top: 55px;">Cadastrar Marca</h2>
                <label>
                    <span>Nome da Marca</span>
                    <input class="form-control" id="nome-marca" name="nome-marca" required="required" type="text" placeholder="marca">
                </label>
                <label>
