...
<head>
	...
	<title>CarCenter - Concessionária</title>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-4 col-xs-6">
					<div class="shop">
						<div class="shop-img">
							<img src="./img/fiat-mobi-1.0-evo-flex-like.-manual-wmimagem19322323252.jpg" alt="">
						</div>
						<div class="shop-body">
							<h3>Econômia</h3>
							<a href="#" class="cta-btn">Ver<i class="fa fa-arrow-circle-right" style="margin-right: 5px;"></i></a>
						</div>
					</div>
				</div>
				<!-- /shop -->
				...
				<div class="col-md-4 col-xs-6">
					<div class="shop">
						<div class="shop-img">
							<img src="./img/toyota-hilux-sw4-2.8-d4d-turbo-diesel-srx-7l-4x4-automatico-wmimagem15374892734.jpg"
								alt="">
						</div>
						<div class="shop-body">
							<h3>Espaço</h3>
				...
				<div class="col-md-4 col-xs-6">
					<div class="shop">
						<div class="shop-img">
							<img src="./img/ford-mustang-5.0-v8-tivct-gasolina-mach-1-selectshift-wmimagem16512139111.jpg"
								alt="">
						</div>
						<div class="shop-body">
							<h3>Potência</h3>
			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="section-title">
						<h3 class="title">Novos anúncios</h3>
						<!--<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab1">Sedan</a></li>
									<li><a data-toggle="tab" href="#tab1">Picapes</a></li>
									<li><a data-toggle="tab" href="#tab1">Hatch</a></li>
									<li><a data-toggle="tab" href="#tab1">Utilitários</a></li>
								</ul>
							</div>-->
					</div>
				</div>
						...
						<div class="products-tabs">
							...
							<div id="tab1" class="tab-pane active">
								<div class="products-slick" data-nav="#slick-nav-1">
									...
									<div class="product">
										<div class="product-img">
											<img src="./img/chevrolet-cruze-1.4-turbo-lt-16v-flex-4p-automatico.jpg"
												alt="">
										...
										<div class="product-body">
											...
											<h3 class="product-name"><a href="#">Cruze 1.4 turbo lt 16v flex</a></h3>
											<h4 class="product-price">R$110.470<del class="product-old-price"></del>
											</h4>
											...
											<div class="product-btns">
												<!--<button class="add-to-wishlist"><i class="fa fa-heart-o"></i><span class="tooltipp">adi</span></button>-->
